...
contextBridge.exposeInMainWorld("api",{
    send: (channel, ...data) =>{
        let ALLOWED_CHANNELS = ["fetch-all-devices","db-create","db-get","db-delete","create-report", "delete-report","get-reports"];
    ...
    receive: (channel, cb) => {
        let ALLOWED_CHANNELS = ["all-devices","receive-db","receive-reports"];
        HARDWARE_CATEGORIES.forEach(category =>{
